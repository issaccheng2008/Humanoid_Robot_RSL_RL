...
def some_public_function(x: int):
    print("[humanoid_robot_policy_rsl_rl] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[humanoid_robot_policy_rsl_rl] startup")
    ...
    def on_shutdown(self):
        print("[humanoid_robot_policy_rsl_rl] shutdown")